...
RULER_PATTERNS = [
    ...
    {"label": "FIN_PRODUCT", "pattern": "овердрафт"},
    {"label": "FIN_PRODUCT", "pattern": "срочный вклад"},
    {"label": "FIN_PRODUCT", "pattern": "вклад до востребования"},
    {"label": "FIN_PRODUCT", "pattern": "сберегательный сертификат"},
    ...
    {"label": "FIN_PRODUCT", "pattern": "облигация федерального займа"},
    {"label": "FIN_PRODUCT", "pattern": "ОФЗ"},
    {"label": "FIN_PRODUCT", "pattern": "вексель"},
    {"label": "FIN_PRODUCT", "pattern": "акция"},
    ...
    {"label": "FIN_PRODUCT", "pattern": "ОСАГО"},
    ...
    {"label": "FIN_ATTRIBUTE", "pattern": "ключевая ставка"},
    {"label": "FIN_ATTRIBUTE", "pattern": "ставка рефинансирования"},
    {"label": "FIN_ATTRIBUTE", "pattern": "плавающая ставка"},
    {"label": "FIN_ATTRIBUTE", "pattern": "фиксированная ставка"},
    {"label": "FIN_ATTRIBUTE", "pattern": "переменная процентная ставка"},
    ...
    {"label": "FIN_ATTRIBUTE", "pattern": "график погашения"},
    ...
    {"label": "FIN_ATTRIBUTE", "pattern": "сумма вклада"},
    {"label": "FIN_ATTRIBUTE", "pattern": "лимит кредитования"},
    ...
    {"label": "FIN_ATTRIBUTE", "pattern": "пополнение вклада"},
    {"label": "FIN_ATTRIBUTE", "pattern": "частичное снятие"},
    {"label": "FIN_ATTRIBUTE", "pattern": "минимальный неснижаемый остаток"},
    ...
    {"label": "FIN_ATTRIBUTE", "pattern": "номинальная стоимость"},
    ...
    {"label": "FIN_ATTRIBUTE", "pattern": "показатель долговой нагрузки"},
    {"label": "FIN_ATTRIBUTE", "pattern": "ПДН"},
    {"label": "FIN_ATTRIBUTE", "pattern": "неустойка"},
    {"label": "FIN_ATTRIBUTE", "pattern": "штраф"},
    {"label": "FIN_ATTRIBUTE", "pattern": "пеня"},

    # ── Actor ─────────────────────────────────────────────────────────────────
    {"label": "FIN_ACTOR", "pattern": "заёмщик"},
    {"label": "FIN_ACTOR", "pattern": "заемщик"},
    {"label": "FIN_ACTOR", "pattern": "кредитор"},
    {"label": "FIN_ACTOR", "pattern": "поручитель"},
    {"label": "FIN_ACTOR", "pattern": "залогодатель"},
    {"label": "FIN_ACTOR", "pattern": "вкладчик"},
    {"label": "FIN_ACTOR", "pattern": "управляющая компания"},
    {"label": "FIN_ACTOR", "pattern": "УК"},
    ...
    {"label": "FIN_ACTOR", "pattern": "депозитарий"},
    {"label": "FIN_ACTOR", "pattern": "регистратор"},
    {"label": "FIN_ACTOR", "pattern": "Банк России"},
    {"label": "FIN_ACTOR", "pattern": "Центральный банк Российской Федерации"},
    {"label": "FIN_ACTOR", "pattern": "ЦБ РФ"},
    {"label": "FIN_ACTOR", "pattern": "Агентство по страхованию вкладов"},
    {"label": "FIN_ACTOR", "pattern": "АСВ"},
    {"label": "FIN_ACTOR", "pattern": "бюро кредитных историй"},
    {"label": "FIN_ACTOR", "pattern": "БКИ"},
    ...
    {"label": "FIN_PROCESS", "pattern": "частичное досрочное погашение"},
    ...
    {"label": "FIN_PROCESS", "pattern": "выплата процентов"},
    ...
    {"label": "FIN_PROCESS", "pattern": "страховая выплата"},
    {"label": "FIN_PROCESS", "pattern": "уступка прав требования"},
    {"label": "FIN_PROCESS", "pattern": "цессия"},
    ...
    {"label": "FIN_CONDITION", "pattern": "при наступлении страхового случая"},
    {"label": "FIN_CONDITION", "pattern": "при досрочном расторжении"},
    {"label": "FIN_CONDITION", "pattern": "при пополнении вклада"},
    {"label": "FIN_CONDITION", "pattern": "не менее трёх лет"},

    # ── LegalTerm ─────────────────────────────────────────────────────────────
    {"label": "FIN_LEGAL", "pattern": "кредитный договор"},
    {"label": "FIN_LEGAL", "pattern": "договор вклада"},
    {"label": "FIN_LEGAL", "pattern": "договор банковского вклада"},
    {"label": "FIN_LEGAL", "pattern": "договор поручительства"},
    {"label": "FIN_LEGAL", "pattern": "договор страхования"},
